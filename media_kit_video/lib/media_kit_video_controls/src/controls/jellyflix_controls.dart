...
const kDefaultJellyflixVideoControlsThemeData =
...
///
/// Theming related data for [JellyflixVideoControls]. These values are used to theme the descendant [JellyflixVideoControls].
///
/// {@endtemplate}
class JellyflixVideoControlsThemeData {
  // BEHAVIOR
  ...
  /// {@macro jellyflix_video_controls_theme_data}
  const JellyflixVideoControlsThemeData({
  ...
  /// Creates a copy of this [JellyflixVideoControlsThemeData] with the given fields replaced by the non-null parameter values.
  JellyflixVideoControlsThemeData copyWith({
    bool? displaySeekBar,
...
///
/// Inherited widget which provides [JellyflixVideoControlsThemeData] to descendant widgets.
///
/// {@endtemplate}
class JellyflixVideoControlsTheme extends InheritedWidget {
  final JellyflixVideoControlsThemeData normal;
  final JellyflixVideoControlsThemeData fullscreen;
  const JellyflixVideoControlsTheme({
    super.key,
  ...
  static JellyflixVideoControlsTheme? maybeOf(BuildContext context) {
    //printWidgetTree();
    return context
        .dependOnInheritedWidgetOfExactType<JellyflixVideoControlsTheme>();
  }

  static JellyflixVideoControlsTheme of(BuildContext context) {
    final JellyflixVideoControlsTheme? result = maybeOf(context);
    assert(
      result != null,
      'No [JellyflixVideoControlsTheme] found in [context]',
    );
    return result!;
  }

  @override
  bool updateShouldNotify(JellyflixVideoControlsTheme oldWidget) =>
      identical(normal, oldWidget.normal) &&
      identical(fullscreen, oldWidget.fullscreen);
}

/// {@macro jellyflix_video_controls}
class _JellyflixVideoControls extends StatefulWidget {
  const _JellyflixVideoControls();

  @override
  State<_JellyflixVideoControls> createState() =>
      _JellyflixVideoControlsState();
}

/// {@macro jellyflix_video_controls}
class _JellyflixVideoControlsState extends State<_JellyflixVideoControls> {
