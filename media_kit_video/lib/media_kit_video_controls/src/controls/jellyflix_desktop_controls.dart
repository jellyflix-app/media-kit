...
///
/// {@endtemplate}
Widget JellyflixDesktopVideoControls(VideoState state) {
  return const VideoControlsThemeDataInjector(
    child: _JellyflixDesktopVideoControls(),
  );
}
...
const kDefaultJellyflixDesktopVideoControlsThemeData =
    JellyflixDesktopVideoControlsThemeData();

/// Default [JellyflixDesktopVideoControlsThemeData] for fullscreen.
const kDefaultJellyflixDesktopVideoControlsThemeDataFullscreen =
    JellyflixDesktopVideoControlsThemeData();

/// {@template material_desktop_video_controls_theme_data}
///
/// Theming related data for [JellyflixDesktopVideoControls]. These values are used to theme the descendant [JellyflixDesktopVideoControls].
///
/// {@endtemplate}
class JellyflixDesktopVideoControlsThemeData {
  // BEHAVIOR
  ...
  JellyflixDesktopVideoControlsThemeData copyWith({
    bool? displaySeekBar,
...
///
/// Inherited widget which provides [JellyflixDesktopVideoControlsThemeData] to descendant widgets.
///
/// {@endtemplate}
class JellyflixDesktopVideoControlsTheme extends InheritedWidget {
  final JellyflixDesktopVideoControlsThemeData normal;
  final JellyflixDesktopVideoControlsThemeData fullscreen;
  const JellyflixDesktopVideoControlsTheme({
    super.key,
  ...
  static JellyflixDesktopVideoControlsTheme of(BuildContext context) {
    final JellyflixDesktopVideoControlsTheme? result = maybeOf(context);
    assert(
      result != null,
  ...
  @override
  bool updateShouldNotify(JellyflixDesktopVideoControlsTheme oldWidget) =>
      identical(normal, oldWidget.normal) &&
      identical(fullscreen, oldWidget.fullscreen);
}

/// {@macro material_desktop_video_controls}
class _JellyflixDesktopVideoControls extends StatefulWidget {
  const _JellyflixDesktopVideoControls();

  @override
  State<_JellyflixDesktopVideoControls> createState() =>
      _JellyflixDesktopVideoControlsState();
}

/// {@macro material_desktop_video_controls}
class _JellyflixDesktopVideoControlsState
    extends State<_JellyflixDesktopVideoControls> {
...
class JellyflixDesktopSeekBar extends StatefulWidget {
...
class JellyflixDesktopSeekBarState extends State<JellyflixDesktopSeekBar> {
  bool hover = false;
  bool click = false;
  double slider = 0.0;
